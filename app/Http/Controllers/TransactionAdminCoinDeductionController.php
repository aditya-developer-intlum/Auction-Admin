...
use App\Exports\TransactionAdminCoinDeductionExport;
use Maatwebsite\Excel\Facades\Excel;
use App\Transaction;
use Carbon\Carbon;

class TransactionAdminCoinDeductionController extends Controller
{
	private static $type = 17;
    ...
    public function __invoke(Request $request)
    {
        ...
        ->belowTable($request)
        ->merge();
    	return view("transactions.admin-coin-deduction",$this->data);
    }
    ...
    private function coinDeduct(Request $request)
    {
    ...
    public function export(Request $request)
    {
        ...
        return Excel::download(new TransactionAdminCoinDeductionExport($this->belowTable), 'admin deduct gift.xlsx');
    }
}
