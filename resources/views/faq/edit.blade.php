...
<div class="_ad-body">
                ...
                <div class="_ad-body-main">
                    ...
                    <div class="_aucInfo-box-outer">
                        <h2 style="text-align:center"><strong> Edit Faqs</strong></h2>
                    <form  method="POST" action="{{route('faq.update',$faq->id)}}" class="row" enctype="multipart/form-data">
                          @csrf
                          @method('PUT')
                            <!-- Left Section  -->
                                    ...
                                    <div class="_aucInfo-box-lft-btm">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <option value="{{$_faqCategory->id}}" {!! $_faqCategory->id==$faq->faq_category_id ? 'selected' : '' !!}>{{$_faqCategory->name}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="description"  id="desc">{{$faq->description}}</textarea>
