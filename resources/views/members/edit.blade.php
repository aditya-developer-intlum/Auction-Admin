...
<div class="_ad-body">
                ...
                <div class="_ad-top-hdr">
                    <p class="_page-title">Edit  Member  +</p>
                </div>
                <!-- Admin Body Main -->
                <div class="_ad-body-main">
                    <!-- Div : Begin -->
                    <div class="_aucInfo-box-outer">
                        <form  method="POST" action="{{route('member.update',$member->id)}}" class="row" enctype="multipart/form-data">
                          @csrf
                            <!-- Left Section  -->
                                    ...
                                    <div class="_aucInfo-box-lft-btm">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"  class="form-control" name="name" value="{{$member->name}}" placeholder="Enter the Full Name">
                                            ...
                                            <div class="col-md-6">
                                             <div class="form-group">
                                                ...
                                                <input type="email"  class="form-control" name="email" value="{{$member->email}}" placeholder="Enter the Email" >
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <input type="number"  class="form-control" name="mobile" value="{{$member->mobile_number}}" placeholder="Enter the Mobile Number" >
                                              ...
                                              <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text"  class="form-control" name="user_name" value="{{$member->user_name}}" placeholder="Enter the Username" >
                                              ...
                                              <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <img src="{{asset('storage/'.$member->avatar)}}"class="img-thumbnail" width="75" alt="">
                                                </div>
                                              </div>
                                              <div class="col-md-12">
                                                <div class="form-group">
