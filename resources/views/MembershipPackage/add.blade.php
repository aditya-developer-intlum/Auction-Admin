...
<div class="_ad-body">
                ...
                <div class="_ad-top-hdr">
                    <p class="_page-title">Memebership Package +</p>
                </div>
                <!-- Admin Body Main -->
                                ...
                                <form action="{{route('membership-package.store')}}" method="POST">
                                    ...
                                    <ul class="_aucPro-lists _aucPro-lists-2 _aucPro-form">
                                        <li>
                                            ...
                                            <input type="text" class="form-control" name="name" @error('name') style="box-shadow: 0 0 3px  #CC0000"@enderror  value="{{ old("name") }}" placeholder="">
                                        ...
                                        <li>
                                            ...
                                            <div class="_desc _ac-formGrp">
                                                <input type="number" class="form-control" @error('validity') style="box-shadow: 0 0 3px  #CC0000" @enderror value="{{ old('validity') }}"  name="validity" placeholder="">
                                        ...
                                        <li>
                                            ...
                                            <div class="_desc _ac-formGrp">
                                                <input type="number" class="form-control"  @error('price_per_month') style="box-shadow: 0 0 3px  #CC0000" @enderror value="{{ old('price_per_month')  }}"  name="price_per_month" placeholder="">
                                        ...
                                        <li>
                                            ...
                                            <div class="_desc _ac-formGrp">
                                            <input type="number" class="form-control"  @error('price_after_discount') style="box-shadow: 0 0 3px  #CC0000" @enderror value="{{ old('price_after_discount')}}" name="price_after_discount"placeholder="">
                                        ...
                                        <li>
                                            ...
                                            <div class="_desc _ac-formGrp">
                                            <input type="number" class="form-control"  @error('discount_on_coins_price') style="box-shadow: 0 0 3px  #CC0000" @enderror value="{{ old('discount_on_coins_price')}}" name="discount_on_coins_price" placeholder="">
                                        ...
                                        <li>
                                            ...
                                            <div class="_desc _ac-formGrp">
                                            <input type="number" class="form-control"  @error('extra_coins') style="box-shadow: 0 0 3px  #CC0000" @enderror value="{{ old('extra_coins')}}"  name="extra_coins" placeholder="">
                                        ...
                                        <li>
                                            ...
                                            <div class="_desc _ac-formGrp">
                                            <input type="number" class="form-control"  @error('total_price') style="box-shadow: 0 0 3px  #CC0000 @enderror" value="{{ old('total_price')}}" name="total_price" placeholder="">
                                        ...
                                        <li>
                                            ...
                                            <div class="_desc _ac-formGrp">
                                            <input type="number" class="form-control"  @error('total_discounted_price') style="box-shadow: 0 0 3px  #CC0000" @enderror value="{{ old('total_discounted_price')}}" name="total_discounted_price" placeholder="">
                                    ...
                                    <div class="_btn-grps">
                                        <button type="submit" class="btn _btn2 _btn-small _bg-green-2" >ADD</button>
                                    </div>
                                </form>
