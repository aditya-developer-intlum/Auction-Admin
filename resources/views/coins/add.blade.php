...
@section('content')
                ...
                <div class="_ad-body">
                    ...
                    <div class="_ad-top-hdr">
                        <p class="_page-title">Add Package</p>
                    </div>
                    <!-- Admin Body Main -->
                        ...
                        <div class="row _pCoin-row">
                           <!-- Col : Begin  -->
                            <div class="col-lg-6 col-md-12 _pCoin-col">
                                ...
                                <form class="_packg-form" method="post" action="{{ route('coins.store')}}">
                                    <input type="hidden" name="normal" value="n">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                ...
                                                <input type="text" name="package_name" @error('package_name') style="box-shadow: 0 0 3px  #CC0000"@enderror value="{{ old('package_name')}}" class="form-control" placeholder="">                                                                                                    
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="package_price" @error('package_price') style="box-shadow: 0 0 3px  #CC0000"@enderror value="{{ old('package_price')}}" class="form-control" placeholder="">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="price_after_discount" @error('price_after_discount')style="box-shadow: 0 0 3px  #CC0000" @enderror value="{{ old('price_after_discount') }}" class="form-control" placeholder="">
                                                    <span class="_frm-info">&#8377</span> 
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="p_member_pay" @error('p_member_pay') style="box-shadow: 0 0 3px  #CC0000" @enderror value="{{ old('p_member_pay') }}" class="form-control" placeholder="">
                                                    <span class="_frm-info">&#8377</span>  
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="value_coins" @error('value_coins') style="box-shadow: 0 0 3px  #CC0000" @enderror value="{{ old('value_coins')}}" class="form-control" placeholder="">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="extra_coins" @error('extra_coins') style="box-shadow: 0 0 3px  #CC0000"@enderror value="{{ old('extra_coins') }}" class="form-control" placeholder="">
                                                    <span class="_frm-info _frm-info-right _text-green-2">COINS</span>       
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="total_coins" @error('total_coins')style="box-shadow: 0 0 3px  #CC0000" @enderror value="{{ old('total_coins') }}" class="form-control" placeholder="">
                                                    <span class="_frm-info _frm-info-right _text-green-2">COINS</span>     
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="p_member_exta_coins" @error('p_member_exta_coins') style="box-shadow: 0 0 3px  #CC0000" @enderror value="{{ old('p_member_exta_coins')}}" class="form-control" placeholder="">
                                                    <span class="_frm-info _frm-info-right _text-green-2">COINS</span>   
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="you_can_save" @error('you_can_save') style="box-shadow: 0 0 3px  #CC0000" @enderror value="{{ old('you_can_save') }}" class="form-control" placeholder="">
                                                    <span class="_frm-info">&#8377</span>     
                                ...
                                <form class="_packg-form" method="post" action="{{ route('coins.store')}}">
                                    @csrf
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                    <select type="text" name="premium_pack_category" @error('premium_pack_category') style="box-shadow: 0 0 3px  #CC0000" @enderror class="form-control" placeholder="">
                                                        ...
                                                        <option value="1" @if( old('premium_package_name') =="1") selected @endif >M1</option>
                                                        <option value="3" @if( old('premium_package_name') =="3") selected @endif >M3</option>
                                                        <option value="6" @if( old('premium_package_name') =="6") selected @endif>M6</option>
                                                        <option value="12"@if( old('premium_package_name') =="12") selected @endif>M12</option>                                                       
                                                    </select>   
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="premium_package_name" value="{{old('premium_package_name')}}" @error('premium_package_name')style="box-shadow: 0 0 3px  #CC0000" @enderror class="form-control" placeholder="">
                                                    <span class="_frm-info">&#8377</span>   
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="premium_package_price" value="{{old('premium_package_price')}}" @error('premium_package_price')style="box-shadow: 0 0 3px  #CC0000" @enderror class="form-control" placeholder="">
                                                    <span class="_frm-info">&#8377</span>   
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="premium_price_after_discount" value="{{old('premium_price_after_discount')}}" @error('premium_price_after_discount')style="box-shadow: 0 0 3px  #CC0000"@enderror class="form-control" placeholder="">
                                                    <span class="_frm-info">&#8377</span>   
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="premium_p_member_pay" value="{{ old('premium_p_member_pay') }}" @error('premium_p_member_pay') style="box-shadow: 0 0 3px  #CC0000" @enderror class="form-control" placeholder="">
                                                    <span class="_frm-info">&#8377</span> 
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="premium_value_coins" value="{{ old('premium_value_coins') }}" @error('premium_value_coins')style="box-shadow: 0 0 3px  #CC0000" @enderror class="form-control" placeholder="">
                                                    <span class="_frm-info _frm-info-right _text-green-2">COINS</span>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="premium_extra_coins" value="{{ old('premium_value_coins') }}" @error('premium_extra_coins') style="box-shadow: 0 0 3px  #CC0000"@enderror class="form-control" placeholder="">
                                                    <span class="_frm-info _frm-info-right _text-green-2">COINS</span>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="premium_total_coins" value="{{ old('premium_total_coins')}}" @error('premium_total_coins')style="box-shadow: 0 0 3px  #CC0000"  @enderror class="form-control" placeholder="">
                                                    <span class="_frm-info _frm-info-right _text-green-2">COINS</span>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="premium_p_member_exta_coins" value="{{  old('premium_p_member_exta_coins')}}" @error('premium_p_member_exta_coins')style="box-shadow: 0 0 3px  #CC0000"  @enderror class="form-control" placeholder="">
                                                    <span class="_frm-info _frm-info-right _text-green-2">COINS</span>      
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="premium_you_can_save" value="{{old('premium_you_can_save')}}" @error('premium_you_can_save') style="box-shadow: 0 0 3px  #CC0000" @enderror class="form-control" placeholder="">
                                                    <span class="_frm-info">&#8377</span>    
                            ...
                            <div class="col-lg-6 col-md-12 _pCoin-col">
                                ...
                                <form class="_packg-form" action="{{route('coins.store')}}" method="POST">
                                    @csrf
                                        <!-- Row Begin -->
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="special_trial_package_name" @error('special_trial_package_name') style="box-shadow: 0 0 3px  #CC0000"@enderror value="{{ old('special_trial_package_name')}}" class="form-control" placeholder="">                                                                                                    
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                <input type="text" name="special_trial_package_price" @error('special_trial_package_price')style="box-shadow: 0 0 3px  #CC0000" @enderror value="{{old('special_trial_package_price')}}" class="form-control" placeholder="">
                                                    <span class="_frm-info">&#8377</span> 
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                    <input type="text" name="special_trial_price_after_discount" @error('special_trial_price_after_discount') style="box-shadow: 0 0 3px  #CC0000" @enderror class="form-control" placeholder="">
                                                    <span class="_frm-info">&#8377</span>   
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-8 col-md-8">
                                                <div class="_packgForm-grp">
                                                    <input type="text" name="special_trial_value_coins" @error('special_trial_value_coins')style="box-shadow: 0 0 3px  #CC0000" @enderror class="form-control" placeholder="">
                                                    <span class="_frm-info _frm-info-right _text-green-2">COINS</span> 
