...
<div class="_ad-body">
                ...
                <div class="_ad-top-hdr">
                    <p class="_page-title"> Auctions Claim & Settlement (Processed / Settled Claims)</p>
                </div>
                <!-- Admin Body Main -->
        ...
        <tbody>
            @foreach ($auctionClaims as $key => $claim)
                <tr>
                    ...
                    <td>{{ $claim->winner->uplinkOne?$claim->winner->uplinkOne->user_name:'N/A' }}</td>
                    <td>{{ $claim->uplevel1_claim??'N/A' }}</td>
                    <td>{{ $claim->uplevel1_status_text ?? 'N/A' }}</td>
                    <td>{{ $claim->winner->uplinkTwo?$claim->winner->uplinkTwo->user_name:'N/A' }}</td>
