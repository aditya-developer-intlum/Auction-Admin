...
<div class="_ad-body">
                ...
                <div class="_ad-top-hdr">
                    <p class="_page-title">Admin Coin Gift</p>
                </div>
                <!-- Admin Body Main -->
...
<div class="container-fluid">
    <div class="col-md-12">
                    ...
                    <div class="_aucTable-div-2">  
                        ...
                        <div class="col-md-1">
                            <form action="{{ route('transaction.admin.coin.gift.export') }}">
                                @foreach ($_GET as $key => $value)
                                    <input type="hidden" name="{{ $key }}" value="{{ $value }}">
                                @endforeach
...
$(function() {
    ...
    if(localStorage.getItem("transaction_admin_coin_start") && localStorage.getItem("transaction_admin_coin_end")){
        var start = moment(localStorage.getItem("transaction_admin_coin_start"));
        var end = moment(localStorage.getItem("transaction_admin_coin_end"));
    ...
    function cb(start, end) {
        ...
        localStorage.setItem('transaction_admin_coin_start',start);
        localStorage.setItem('transaction_admin_coin_end',end);
    }
