...
<div class="_ad-body">
                ...
                <div class="_ad-top-hdr">
                    <p class="_page-title">Create SubAdmin  +</p>
                </div>
                                @if ($errors->any())
                ...
                <div class="_ad-body-main">
                    ...
                    <div class="_aucInfo-box-outer">
                        <form  method="POST" action="{{ route('sub-admin.store') }}" class="row" enctype="multipart/form-data">
                          @csrf
                            <!-- Left Section  -->
                                    ...
                                    <div class="_aucInfo-box-lft-btm">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"  class="form-control" name="name" value="{{old('name')}}" placeholder="enter the number">
                                            </div>
                                            </div>
                                            <div class="col-md-6">
                                             <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="number"  class="form-control" name="mobile_number" value="{{old('mobile_number')}}"  placeholder="enter the mobile" >
                                                   @error("mobile")
                                              ...
                                              <div class="col-md-12">
                                                ...
                                                <input type="text"  class="form-control" name="password" value="{{old('password')}}" placeholder="enter the password" >
                                                   @error("password")
                                                   <span class="text-danger"></span>
                                                   @enderror
                                                </div>
                                              ...
                                              <div class="col-md-12">
                                                ...
                                                <input type="text"  class="form-control" name="confirm_password" value="{{old('confirm_password')}}" placeholder="enter the Confirm Password" >
