                                    ...
                                    <div class="_aucInfo-box-lft-btm">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div   class="form-control"> {{$subAdmin->name}}</div>
                                            </div>
                                            </div>
                                            <div class="col-md-6">
                                             <div class="form-group">
                                                <label for="email">Email</label>
                                                <div   class="form-control"> {{$subAdmin->email}}</div>
                                             </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                   <label for="mobile">Mobile </label>
                                                   <div   class="form-control"> {{$subAdmin->mobile_number}}</div>
                                                </div>
                                              </div>
                                              <div class="col-md-12">
                                                <div class="form-group">
                                                   <label for="image">Profile Image </label>
                                                <img src="{{asset('storage/'.$subAdmin->avatar)}}" class="img-thumbnail" width="150" width="150" alt="">
                                                </div>
                                              </div>
